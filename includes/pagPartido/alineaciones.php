...
<div class="col-xs-12">
    ...
    $cambioTiempo = 1;
        ...
        $golTipo=$GolT['esLocal'];

        if (10 == $GolT['tipo']) {
            $balon = '/img/balonR.png';
            if ($GolT['esLocal']==1){ $golTipo=0; }
            if ($GolT['esLocal']==0){ $golTipo=1; }
        ...
        if ($GolT['minuto'] > 200) {
            $txtTiempo = '2ºT';
            if ((int)$txtMinuto>90){ $txtMinuto="90+".($txtMinuto-90); }
        } else {
            $txtTiempo = '1ºT';
            if ((int)$txtMinuto>45){ $txtMinuto="45+".($txtMinuto-45); }
        } ?>
        <tr>
        <?php if (1 == $golTipo) {
            ?>
