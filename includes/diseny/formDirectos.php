...
<table width="100%" bgcolor="#eeffbb">
    ...
    <td>
        <a href="/panelBack/apiTwitter/configuracion.php?cadena=<?php echo $fila['twLocal']; ?>%20OR%20<?php echo $fila['twVisitante']; ?>"
         target="_blank">TW2</a> - 

        <span class="add-tw glyphicon glyphicon-plus-sign"
                      data-l="<?php echo $fila['twLocal']; ?>"
                      data-v="<?php echo $fila['twVisitante']; ?>"
                      ></span>
    </td>
</tr></table>
</form>
...
<tr bgcolor="<?php echo $color_fila?>"><td>
  ...
  <td>
    ...
    <a onclick="verPartido(<?php echo $fila['betsapi']; ?>,1)">betsapi</a>: <input type="text" name="apiId" size="6" value="<?php echo $fila['betsapi']; ?>">
