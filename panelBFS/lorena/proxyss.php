...
<div style="width: 100%; float: left;">
	...
	<div style="overflow: auto; height: 900px; width: 350px; float: left; text-align: center">
		<form action="proxyss.php" method="post">
			...
			<input type="submit" name="enviar" value="cargarProxis"> <a href="https://www.proxy-list.download/es/HTTPS" target="_blank">Abrir lista de proxis HTTPS</a><br />
