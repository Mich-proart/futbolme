...
$file = '../../../panelBack/federacion/'.$territorial.'/calendarios/'.$grupo_id.'-jornadas.json';
...
for ($jda=$jornada_inicio; $jda < $maximoJ; $jda++) {
	...
	switch ($comunidad_id) {
		case 1:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidos.php');break;
		case 3:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidos.php');break;
		case 5:include('../../../panelBack/simple/'.$carpeta.'/edpCAT.php');break;
		case 7:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidosM.php');break;
		case 9:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidos.php');break;	
		case 10:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidos.php');break;	
		case 11:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidosM.php');break;	
		case 13:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidos.php');break;
		case 14:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidos.php');break;	
		case 16:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidos.php');break;
		case 17:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidos.php');break;	
		case 18:include('../../../panelBack/simple/'.$carpeta.'/extraerDatosPartidos.php');break;				
	}
...
if (isset($partidosJornada)){
	...
	$file = '../../../panelBack/federacion/'.$territorial.'/calendarios/'.$grupo_id.'-equipos.json';
