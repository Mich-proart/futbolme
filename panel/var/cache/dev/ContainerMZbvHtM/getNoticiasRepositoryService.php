...
// Returns the private 'App\Repository\NoticiasRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NoticiasRepository.php';

return $this->privates['App\\Repository\\NoticiasRepository'] = new \App\Repository\NoticiasRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
