...
// Returns the private 'App\Repository\PartidoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PartidoRepository.php';

return $this->privates['App\\Repository\\PartidoRepository'] = new \App\Repository\PartidoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
