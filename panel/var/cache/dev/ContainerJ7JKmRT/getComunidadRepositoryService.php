...
// Returns the private 'App\Repository\ComunidadRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComunidadRepository.php';

return $this->privates['App\\Repository\\ComunidadRepository'] = new \App\Repository\ComunidadRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
