...
// Returns the private 'App\Repository\EquiposRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EquiposRepository.php';

return $this->privates['App\\Repository\\EquiposRepository'] = new \App\Repository\EquiposRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
