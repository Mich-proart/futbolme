<div class="panel panel-default">
				...
				<tbody class="whitebox">					 
					<?php	
                        foreach ($enfrentamientos as $partido) {
                            ...
                            $enlace = '/historico/promocion3/index.php?temporada_id='.$partido['historicotemporadas_id']; ?>													
						<tr>														
							...
							<td>
							<?php $enlace = '/historico/promocion3/index.php?partido_id='.$partido['id'].'&pest=partido'; ?>
    ...
    $enlace = '/historico/promocion3/index.php?equipo_id='.$equipoenf2.'&pest=equipo'; ?>
			...
			<div class="row h25 nomargin" style="background-color:gainsboro"></div>
				...
				<div class="nopadding col-xs-12 col-md-6 col-lg-6">
                    ...
                    foreach ($partisyrivales['participacionesEquipo'] as $parti) {
                        ...
                        $enlace = '/historico/promocion3/index.php?temporada_id='.$parti['historicotemporadas_id'].'&equipo_id='.$_GET['equipo_id'].'&pest=temporadaid';
				...
				<div class="nopadding col-xs-12 col-md-6 col-lg-6">
                    ...
                    foreach ($nuevo as $parti) {
                        ...
                        $enlace = '/historico/promocion3/index.php?equipo_id='.$_GET['equipo_id'].'&equipo_id2='.$parti['fm_id'].'&pest=equipo&enf=1';
