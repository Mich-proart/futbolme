...
switch ($comunidad_id) {
	...
	$url='https://www.isquad.es/competiciones_publico.php?id_temporada=70&id_ambito=6&asdfg=1&'; //&id_ambito=6
	$urlWebJor='https://www.isquad.es/competiciones_publico.php?id_temporada=70xxx&id_ambito=6&asdfg=1&'; 
	...
	$url='https://www.isquad.es/competiciones_publico.php?id_temporada=70&id_ambito=3&asdfg=1&'; //&id_ambito=3
	$urlWebJor='https://www.isquad.es/competiciones_publico.php?id_temporada=70xxx&id_ambito=6&asdfg=1&'; 
	break;
	...
	$url='https://www.isquad.es/competiciones_publico.php?id_temporada=70&id_ambito=2&asdfg=1&';//&id_ambito=??
	$urlWebJor='https://www.isquad.es/competiciones_publico.php?id_temporada=70xxx&id_ambito=6&asdfg=1&'; 
	break;

	case '15':
	$carpeta='00isquad'; $territorial='12';
	$url='https://www.isquad.es/competiciones_publico.php?id_temporada=70&id_ambito=18&asdfg=1&'; //&id_ambito=18
	$urlWebJor='https://www.isquad.es/competiciones_publico.php?id_temporada=70xxx&id_ambito=6&asdfg=1&'; 
	break;
	...
	$url=$rot.'/pnfg/NPcd/NFG_CmpJornada?cod_primaria=1000120&CodTemporada=16&CodJornada=1&Sch_Tipo_Juego=';
	$urlWeb=$rot.'/pnfg/NPcd/yyy?cod_primaria=1000120xxx&CodTemporada=16&CodJornada=1&Sch_Tipo_Juego=';
	break;
	...
	$idTemporadaFederacion=16;
	$url='http://pbvallirana.fcf.novanet.es/pnfg/NPcd/NFG_CmpJornada?cod_primaria=1000120&CodTemporada='.$idTemporadaFederacion.'&cod_agrupacion=1&Sch_Codigo_Delegacion=&Sch_Tipo_Juego=&';
	$urlj1='http://pbvallirana.fcf.novanet.es/pnfg/NPcd/NFG_CmpJornada?cod_primaria=1000120xxx&CodTemporada=16&CodJornada=1&cod_agrupacion=1&Sch_Codigo_Delegacion=&Sch_Tipo_Juego=';
	$urlClasi='http://pbvallirana.fcf.novanet.es/pnfg/NPcd/NFG_VisClasificacion?cod_primaria=1000120';
	$urlCalendario='http://pbvallirana.fcf.novanet.es/pnfg/NPcd/NFG_VisCalendario_Vis?cod_primaria=1000120&codtemporada='.$idTemporadaFederacion;
	$urlClub='http://pbvallirana.fcf.novanet.es/pnfg/NPcd/NFG_VerClub?cod_primaria=1000118&codigo_club=';
	

	$url='http://fcf.cat/resultats/2021/futbol-11/'; //segona-catalana-primera-fase/subgrup-1a
	$urlClasi='http://fcf.cat/classificacio/2021/futbol-11/';
	$urlCalendario='http://fcf.cat/calendari/2021/futbol-11/';
	$urlClub='';
	$urlEquipo='http://fcf.cat/equip/2021/'; //2cat/besalu-ce-a
	...
	$dominio="https://www.rfaf.es/";
	//$dominio="http://adminpcrfaf.novanet.es/";
	$idTemporadaFederacion=15;

	$url=$dominio.'pnfg/NPcd/NFG_CmpJornada?cod_primaria=1000120&CodTemporada='.$idTemporadaFederacion.'&cod_agrupacion=1&Sch_Codigo_Delegacion=&Sch_Tipo_Juego=&';

	$page=10; //casi 4600 registros. Se necesitan dos páginas //1150 por pagina
	$urlClubes=$dominio.'pnfg/NPcd/NFG_Clubes?cod_primaria=1000118&NPcd_Page='.$page.'&nueva_ventana=&Buscar=1&orden=&cod_club=&nclub=&Sch_CodCategoria=&cod_provincia=&localidad_txt=--+Seleccione+Provincia+--&localidad=0&code_delegacion=&cod_delegacion=&cod_postal=&NPcd_PageLines=';

	$urlClub=$dominio.'pnfg/NPcd/NFG_VerClub?cod_primaria=1000118&codigo_club=';

	$urlNews=$dominio.'pnfg/NNws_LstNews?cod_primaria=5000289';

	$urlAgenda='';	

	$urlActa=$dominio.'pnfg/NFG_CmpPartido?cod_primaria=1000120&CodActa=xxx&cod_acta=xxx';
