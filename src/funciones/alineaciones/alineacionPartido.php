...
<div style="float:left; width:50%">	
	<table width='100%' border='0' cellpadding='1' cellspacing='1' bgcolor='gainsboro'>
		<tr><td></td>
			...
			<?php echo $fila['local']; ?> (<?php echo $fila['equipoLocal_id']; ?>)
			...
			<?php 
                ...
                $txtlocal = 'Local';
                 ?>
					...
					<span onclick="ver_gol(<?php echo $local; ?>,<?php echo $partido_id; ?>,<?php echo $filaJ['id']; ?>)" style="cursor:pointer; border: 1px solid black; padding:2px;"><img src="/img/balon.png" width="12"></span> 
				    <span onclick="ver_tarjeta(<?php echo $local; ?>,<?php echo $partido_id; ?>,<?php echo $filaJ['id']; ?>)" style='color:orange;background:black;cursor:pointer; border: 1px solid black; padding:2px;'><img src="/img/ta.png" width="12"></span>
					</div>
	...
	<table width='100%' border='0' cellpadding='1' cellspacing='1' bgcolor='gainsboro'>
		<tr><td></td>
			<td style="font-size:12px"><?php echo $fila['visitante']; ?> (<?php echo $fila['equipoVisitante_id']; ?>)
		...
		<?php foreach ($resultado2 as $filaJ) {
			...
			<td style="width:40%;" align="right"><span class="hidden-xs"><?php echo $filaJ['posicion']; ?> - <?php echo $filaJ['id']; ?> - </span><b><?php echo $filaJ['apodo']; ?></b> (<?php echo $filaJ['nombre']; ?>)</td>						
			<td style="width:60%;">
			<?php 
                $local = 0;
                $txtlocal = 'Visitante';
