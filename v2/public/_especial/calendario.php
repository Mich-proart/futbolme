...
<table id="e-<?php echo $equipo_id; ?>" class="table" style="padding:20px">
	<thead>
...
foreach ($partidos as $value) {
	...
	<tr id="<?php echo $value['id']; ?>" class="whitebox">
            ...
            <input id="l-<?php echo $equipo_id; ?>-<?php echo $value['id']; ?>" onkeyup="_llenarL(<?php echo $value['id']; ?>,<?php echo $value['equipoLocal_id']; ?>,<?php echo $equipo_id; ?>)" class="l<?php echo $value['id']; ?>" type="text" style="font-size:15px;width:20px;text-align:center;" value="">
            </th>
            <th class="text-center nopadding v-<?php echo $value['id']; ?>" data-visitante="<?php echo $value['equipoVisitante_id']; ?>">
            <input id="v-<?php echo $equipo_id; ?>-<?php echo $value['id']; ?>" onkeyup="_llenarV(<?php echo $value['id']; ?>,<?php echo $value['equipoLocal_id']; ?>,<?php echo $equipo_id; ?>)" class="v<?php echo $value['id']; ?>" type="text" style="font-size:15px;width:20px;text-align:center;" value="">
            </th>
