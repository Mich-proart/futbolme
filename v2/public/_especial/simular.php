...
$clasificacion = $c['clasificacion']['clasificacionFinal'];
$nueva = array();
		...
		<table class="table">
		    ...
		    <tbody class="whitebox">
		        ...
		        <tr data-id="<?php echo $fila['equipo_id']; ?>">
		        	...
		        	<?php echo $key + 1; ?>
		        	<span style="background-color:gainsboro;"><b><?php echo $fila['ant_posicion']; ?></b></span>
		        	</td>
	        		<td id="<?php echo $fila['equipo_id']; ?>" data-posicion="<?php echo $fila['posicion']; ?>" class="nopadding">
	        		 <img src="/static/img/equipos/escudo<?php echo $fila['equipo_id']; ?>.png"  alt="equipo" style="width:18px; height:20px">
	        		...
	        		<span style="background-color:gainsboro;"><b><?php echo $fila['ant_puntos']; ?></b></span>
	        		</td>
