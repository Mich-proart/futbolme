    ...
    function startSearch(c, a) {
        ...
        jQuery.ajax({ url: url_finderant_server, type: "POST", dataType: "json", data: b, cache: false }).done(function (g) {
            ...
            jQuery.each(g.search_result, function (l, r) {
                ...
                f += '<a class="img-content" href="' + r.url + '"><img src="' + r.additional.imagenEscudo + '" alt="" /></a>';
                f +=
                    ...
                    r.additional.nombreCategoria +
                    '</div><div class="description">' +
                    r.additional.nombreLocalidad +
                    " (" +
                    r.additional.nombreProvincia +
                    ") - " +
                    r.additional.nombreComunidad +
                    '</div><div class="separador"><hr /></div><div class="torneos">';
                if (typeof r.additional.torneos != "undefined") {
                    for (torneo in r.additional.torneos) {
                        var j = r.additional.torneos[torneo];
                        f += '<a style="font-size: 11px;" class="enlace-torneo" href="' + j.enlace + '">';
                        f += j.nombreTemporada;
                        f += "</a><br />";
                    }
                }
