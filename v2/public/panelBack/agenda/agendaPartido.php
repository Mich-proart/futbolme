...
$horasD=0;$minutosD=0;$segundosD=0;$invertidoD=0;
$horasD = $dDirecto->h;
$minutosD = $dDirecto->i;
...
if ($minutosD<55 && $mPartido<60) { $parte=1;$minutos=$minutosD;  }
if ($minutosD<55 && $mPartido>59 && $mPartido<120) { $parte=2; $minutos=$minutosD+45; }
if ($minutosD<20 && $mPartido>119 && $mPartido<135) { $parte=3; $minutos=$minutosD+90; }
if ($minutosD<20 && $mPartido>134) { $parte=4; $minutos=$minutosD+105; }
...
if ($hora!=$h){
    if ($colorFondo=='white') { $colorFondo='gainsboro';} else {$colorFondo='white';}
}
...
$colorTexto="white";
    if (strlen($comentarios)>2) {
        ...
        if (6 == $partido['estado_partido']) {
            $t['color'] = '#ffe400';$t['tiempo'] = 'Descanso';$colorTexto = 'maroon';
        }
        if (7 == $partido['estado_partido']) {
            $t['color'] = '#2E2E2E';$t['tiempo'] = 'Penaltis';
        }
        if (8 == $partido['estado_partido']) {
            $t['color'] = 'blue';$t['tiempo'] = 'Prórroga';
        } 
...
if ($partido['estado_partido'] > 2) {
    if (3 == $partido['estado_partido']) {$resultado='SUSP.';$estadoPartido='--';} 
    if (4 == $partido['estado_partido']) {$resultado='APLZ.';$estadoPartido='--';}
}
