...
class PartidoController
{
    ...
    public function index(Request $request, Response $response, $args): Response
    {
        ...
        $fecha22 = new \DateTime($partido['fecha'] . ' ' . $partido['hora_real'], $timezone);
        $fecha2 = $fecha22->format('Y-m-d H:i:s');
        ...
        $fecha33 = new \DateTime($partido['fecha'] . ' ' . $partido['hora_prevista'], $timezone);
        $fecha3 = $fecha33->format('Y-m-d H:i:s');
       
        //$dPartido = date_diff($fecha3, $fecha1);
        $dPartido = $fecha33->diff($currentTime);
        ...
        if (0 == $invertidoP) {
            ...
            if (0 == $diasP) {
                ...
                if ($horasP > 0 && $minutosP > 0) {
                    $txth .= ' y ';
                }
                if (1 == $minutosP) {
                    $txtm = $minutosP . ' minuto';
                }
                if (0 == $minutosP) {
                    $txtm = '';
                }
        ...
        if (count($rachas) == 2) {
            ...
            for ($i = 0; $i < 2; ++$i) {
                ...
                if (0 == $i) {
                    ...
                    if (0 == $eGl && 0 == $eGv) {
                        $txt .= 'no ha ganado ningún partido, ';
                    }
                    if (1 == $eGl && 0 == $eGv) {
                        $txt .= 'solo ha ganado <b>1</b> partido en casa, ';
                    }
                    if (0 == $eGl && 1 == $eGv) {
                        $txt .= 'solo ha ganado <b>1</b> partido como visitante,';
                    }
                    if (1 == $eGl && 1 == $eGv) {
                        $txt .= 'ha ganado <b>2</b> partidos, uno como local y otro como visitante, ';
                    }
                    if ($eGl > 1 && 0 == $eGv) {
                        $txt .= 'ha ganado <b>' . $eGl . '</b> partidos, todos como local,';
                    }
                    if (0 == $eGl && $eGv > 1) {
                        $txt .= 'ha ganado <b>' . $eGv . '</b> partidos, todos como visitante, ';
                    }
                    if (1 == $eGl && $eGv > 1) {
                        $txt .= 'ha ganado <b>1</b> partido como local y <b>' . $eGv . '</b> como visitante, ';
                    }
                    if ($eGl > 1 && 1 == $eGv) {
                        $txt .= 'ha ganado <b>' . $eGl . '</b> partidos como local y <b>1</b> como visitante, ';
                    }
                    if ($eGl > 1 && $eGv > 1) {
                        $txt .= 'ha ganado <b>' . $eGl . '</b> partidos como local y <b>' . $eGv . '</b> como visitante, ';
                    }
                    if (0 == $eEl && 0 == $eEv) {
                        $txt .= 'no ha empatado ningún partido ';
                    }
                    if (1 == $eEl && 0 == $eEv) {
                        $txt .= 'ha empatado <b>1</b> partido en casa ';
                    }
                    if (0 == $eEl && 1 == $eEv) {
                        $txt .= 'solo ha empatado <b>1</b> partido como visitante ';
                    }
                    if (1 == $eEl && 1 == $eEv) {
                        $txt .= 'ha empatado <b>2</b> partidos, uno como local y otro como visitante ';
                    }
                    if ($eEl > 1 && 0 == $eEv) {
                        $txt .= 'ha empatado <b>' . $eEl . '</b> partidos, todos como local ';
                    }
                    if (0 == $eEl && $eEv > 1) {
                        $txt .= 'ha empatado <b>' . $eEv . '</b> partidos, todos como visitante ';
                    }
                    if (1 == $eEl && $eEv > 1) {
                        $txt .= 'ha empatado <b>1</b> partido como local y <b>' . $eEv . '</b> como visitante ';
                    }
                    if ($eEl > 1 && 1 == $eEv) {
                        $txt .= 'ha empatado <b>' . $eEl . '</b> partidos como local y <b>1</b> como visitante ';
                    }
                    if ($eEl > 1 && $eEv > 1) {
                        $txt .= 'ha empatado <b>' . $eEl . '</b> partidos como local y <b>' . $eEv . '</b> como visitante ';
                    }
                    if (0 == $ePl && 0 == $ePv) {
                        $txt .= 'y no ha perdido ningún partido. ';
                    }
                    if (1 == $ePl && 0 == $ePv) {
                        $txt .= 'y ha perdido <b>1</b> partido en casa. ';
                    }
                    if (0 == $ePl && 1 == $ePv) {
                        $txt .= 'y solo ha perdido <b>1</b> partido como visitante. ';
                    }
                    if (1 == $ePl && 1 == $ePv) {
                        $txt .= 'y ha perdido <b>2</b> partidos, uno como local y otro como visitante. ';
                    }
                    if ($ePl > 1 && 0 == $ePv) {
                        $txt .= 'y ha perdido <b>' . $ePl . '</b> partidos, todos como local. ';
                    }
                    if (0 == $ePl && $ePv > 1) {
                        $txt .= 'y ha perdido <b>' . $ePv . '</b> partidos, todos como visitante. ';
                    }
                    if (1 == $ePl && $ePv > 1) {
                        $txt .= 'y ha perdido <b>1</b> partido como local y <b>' . $ePv . '</b> como visitante. ';
                    }
                    if ($ePl > 1 && 1 == $ePv) {
                        $txt .= 'y ha perdido <b>' . $ePl . '</b> partidos como local y <b>1</b> como visitante. ';
                    }
                    if ($ePl > 1 && $ePv > 1) {
                        $txt .= 'y ha perdido <b>' . $ePl . '</b> partidos como local y <b>' . $ePv . '</b> como visitante. ';
                    }
            ...
            <br />En liga, el ' . $etX . ' ha jugado <b>' . count($repera1l) . ' partidos como local</b>.';
                    ...
                    if ($golf == count($repera1l)) {
                        $txt .= 'en todos los partidos.';
                    } else {
                        $txt .= 'algún gol en ' . $golf . ' partidos.
        ...
        if (true or 0 == $invertidoP && $partido['estado_partido'] == 2 && $partido['betsapi'] < 2) {
            ...
            //$dDirecto = date_diff($fecha2, $currentTime);
            $dDirecto = $fecha22->diff($currentTime);
