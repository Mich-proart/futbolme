...
if (1 == $valor) {
    ?>
	document.write ('<div style="clear:both"></div><div style="width:100%; max-width:500px !important; font-family: sans-serif;"><div style="margin-top:10px; font-size:16px; font-weight: bold; background-color: gainsboro; text-align:center;"><img src="https://futbolme.com/apple-touch-icon-precomposed.png" style="float:left"><a href="https://play.google.com/store/apps/details?id=com.futbolme.futbolme" style="text-decoration: none;">Descargate la APP de futbolme desde Google Play</a></div><?php
    if (4 == $tipo) {
