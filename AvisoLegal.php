...
<div class="whitebox" style="text-align:justify; padding:10px">
 <h1 style="text-align: center;">Aviso Legal</h1>
           	<strong>Protección de datos personales</strong><br>
                www.futbolme.com, es un dominio en Internet de titularidad de APLICACIONES Y PROGRAMACION DE BASES DE DATOS, S.L.U. con NIF B97657324, Urb. Pla de les Clotxes, 206. CP 46450 Benifaió (Valencia), Sociedad Inscrita en el Registro Mercantil de Valencia: Libro 5594, Tomo 8303, Folio 57, Hoja V-108744, Inscripción 2ª. Email de contacto <strong>futbolme@futbolme.net</strong><br><br>
                
                <strong>No se obtiene ningún tipo de datos personales</strong><br>
                APLICACIONES Y PROGRAMACION DE BASES DE DATOS, S.L.U. y su portal de FUTBOLME.COM no obtiene ningún tipo de datos personales mediante ningún procedimiento. Basa su información respecto al usuario mediante cookies y tokens proporcionadas por el dispositivo de acceso. Para cualquier información al respecto pueden utilizar el email de contacto <strong>futbolme@futbolme.net</strong><br><br>
