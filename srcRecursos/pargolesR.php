        ...
        if (1 == $value['esLocal'] || 2 == $value['esLocal']) {
            ...
            if (29752 != $value['jugador_id']) {
                if (isset($jugador_id) && $jugador_id == $value['jugador_id']) {
                    $txtJ = "<a href='/jugador.php?id=".$value['jugador_id']."' target='_blank' style='color:red; font-size:14px; font-weight:bold'>".$value['jugador'].'</a>';
                } else {
                    $txtJ = "<a href='/jugador.php?id=".$value['jugador_id']."' target='_blank' style='color:navy'>".$value['jugador'].'</a>';
                }
            } else {
                $txtJ = $value['jugador'];
            }
